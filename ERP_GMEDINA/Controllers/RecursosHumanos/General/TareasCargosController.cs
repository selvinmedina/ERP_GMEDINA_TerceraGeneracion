...
{
    public class TareasCargosController : Controller
    {
        private ERP_GMEDINAEntities db = null;
        Models.Helpers Function = new Models.Helpers();

        // GET: Personas
        [SessionManager("TareasCargos/Index")]
        ...
        [SessionManager("TareasCargos/Detalles")]
                ...
                using (db = new ERP_GMEDINAEntities())
                {
                    var tbPersonas = db.tbPersonas
                        ...
                        p => new
                        {
                            ...
                            per_UsuarioModifica = p.tbUsuario1.usu_NombreUsuario
                        })
        ...
        // GET : Personas/Create
        [SessionManager("TareasCargos/Create")]
        ...
        // GET: Areas/Edit/5
        [SessionManager("TareasCargos/Edit")]
        ...
        // POST: Areas/Delete/5
        [SessionManager("TareasCargos/Delete")]
        [HttpPost]
