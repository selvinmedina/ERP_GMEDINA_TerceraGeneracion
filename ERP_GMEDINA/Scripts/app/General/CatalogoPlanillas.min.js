...
function listar() {
    obtenerIdDetallesEditar("#tblCatalogoPlanillas tbody", table = $(".dataTables-example").DataTable({
        ...
        columns: [{
            ...
            data: "activoAdmin",
            render: function (data) {
                return 0 == data.activo && 1 == data.esAdmin ? Activar : data.activo && data.esAdmin ? DetallesEditar : data.activo || data.esAdmin ? DetallesEditar : ""
            }
        }],
        language: {
            sProcessing: spinner(),
...
function obtenerIdDetallesEditar(tbody, table) {
    "//" == pathname && (pathname = baseUrl), $(document).on("click", "button#btnEditarCatalogoDeducciones", (function () {
        ...
        localStorage.setItem("id", table.row($(this).parents("tr")).data().idPlanilla), localStorage.setItem("element", JSON.stringify($(this).parents("tr"))), $("#InactivarCatalogoDeducciones").modal({
            backdrop: "static",
            keyboard: !1
        })
    ...
    $.ajax({
        ...
        if (0 == data) $("#InactivarCatalogoDeducciones").modal("hide"), iziToast.error({
            ...
            mostrarSpinner($("#btnInactivarPlanilla"), cargandoEliminar), _ajax({
                ...
                }), $("#InactivarCatalogoDeducciones").modal("hide"), table.rows.add(data.data).draw()) : iziToast.error({
                    title: "Error",
