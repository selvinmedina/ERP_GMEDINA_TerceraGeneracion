...
$(document).on("click", "#tblAcumuladosISR tbody tr td #btnEditarAcumuladosISR", function () {
    ...
    if (validacionPermiso.status == true) {
        ...
        console.log("VERIFICAR THIS", this)
        var dataEmp = dataTableAcumuladosISR.row($(this).parents('tr')) //obtener la data de la fila seleccionada


        console.log("VERIFICAR LA DATA DE la tabla", dataTableAcumuladosISR)
        console.log("VERIFICAR LA DATA DE LA FILA SELECCIONADA", dataEmp)
        ...
        $.ajax({
            ...
            .done(function (data) {
                console.log("VERIFICAR LA RESPUESTA DEL AJAX", data)
                ...
                if (data) {
                    ...
                    console.log("VERIFICAR EL DATA EMP NO SE MOSTRARA PORQUE ES UN LET", dataEmp)
...
$("#btnInactivarAcumuladosISREjecutar").click(function () {
    ...
    $.ajax({
        url: "/AcumuladosISR/Inactivar/" + ID,
        method: "POST",
        data: data
    }).done(function (data) {
        if (data == "error") {
