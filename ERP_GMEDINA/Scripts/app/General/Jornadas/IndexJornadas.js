...
$("#btnAgregar").click(function () {
    var validacionPermiso = userModelState("Jornadas/Create");
    if (validacionPermiso.status == true) {
...
function showmodal(btn) {
    var validacionPermiso = userModelState("Jornadas/CreateHorario");
    if (validacionPermiso.status == true) {
        jor_Id = $(btn).data('id');
...
function showmodaledit(btn) {
    var validacionPermiso = userModelState("Jornadas/EditHorario");
    if (validacionPermiso.status == true) {
        jor_Id = $(btn).data('id');
        _ajax(null,
...
function showmodalDetalle(btn) {
    var validacionPermiso = userModelState("Jornadas/DetallesHorario");
    if (validacionPermiso.status == true) {
        jor_Id = $(btn).data('id');
        _ajax(null,
            '/Jornadas/EditHorario/' + jor_Id,
